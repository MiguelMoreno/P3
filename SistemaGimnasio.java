 ...
 * CUANDO SELECIONAR FILTRAR PARA POR ELIMINADO = 0
  */
    ...
    try {
        stmt.executeUpdate("CREATE TABLE Ejercicio (" +
    ...
    // Crear tabla ListaDeseados
    try {
        stmt.executeUpdate("CREATE TABLE ListaDeseados (" +
                "ID_ListaDeseados INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " +
                "ID_Cliente INT NOT NULL," +
                "ID_Producto INT NOT NULL, " +
                "Cantidad INT NOT NULL CHECK (Cantidad > 0), " +
                "Fecha_Añadido DATE DEFAULT SYSDATE NOT NULL," +
                " FOREIGN KEY (ID_Cliente) REFERENCES ClienteIncluyeSuscripcion_Invitacion(ID_Cliente) ON DELETE CASCADE," +
                "FOREIGN KEY (ID_Producto) REFERENCES Producto(ID_Producto) ON DELETE CASCADE");
        } catch (SQLException e) {
            //manejarSQLException(e);
            ...
            while (!salir) {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        ...
                        // Implementar funcionalidad
                        GestionClientes.mostrarMenuGestionClientes(conn, scanner);
                        break;
                    case 3:
                        System.out.println("Gestión de Actividades seleccionado.");
                        // Implementar funcionalidad
                        GestionActividades.mostrarMenuGestionActividades(conn, scanner);
                        break;
                    case 4:
